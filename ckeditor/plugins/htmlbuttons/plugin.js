...
CKEDITOR.config.htmlbuttons =	[
	
	{
		name:'button2',
		icon:'call.png',
		html:'<a class="btn btn-call" href="tel:080030700">Call</a>',
		title:'CALL'
	},
	{
		name:'Chat',
		icon:'chat.png',
		html:'<a class="btn btn-call" href="https://vdab.be/werzoeken/chat.shtml" target="_blank">Chat meet een medewerker</a>',
		title:'Chat meet een medewerker'
	}	
